...
const BOOM_QUESTIONS: BoomQuestion[] = [
  ...
  { text: "¿Cuál es el streamer con el que ha hecho más TikToks?", answer: "NONI" },
  ...
  { text: "¿Qué artista le escribió una canción a Pol?", answer: "PEP SALA" },
  { text: "¿Nombre de la canción que Pep Sala le escribió a Pol?", answer: "NÚVOLS DE COLOR" },
  { text: "¿Con qué película nominaron a Pol a 'mejor dirección de fotografía en los premios Gaudí'?", answer: "XTREMS" },
  { text: "¿Persona que le dice Espabila a Pol?", answer: "SUUGGIE" },
  { text: "¿Genia creativa detrás de los emotes y badges de Polispol?", answer: "CABRUU" },
  { text: "¿Nombre del blog de Pol donde nos habla de fotografía?", answer: "DIRECTORDEFOTOGRAFIA" },
  { text: "¿Nombre del cine favorito de Pol?", answer: "PHENOMENA" },
  { text: "¿Película en la que Pol participó como Director de Fotografía rodada en Madrid?", answer: "VENUS" },
  { text: "¿Cómo se le llama a la comunidad que creó Polispol?", answer: "POLICARPIERS" },
  { text: "¿Pol conoció a Jon M. Chu, director de?", answer: "WICKED" },
  { text: "¿Qué personaje de Toy Story fue secuestrado por Pol?", answer: "WOODY" },
  { text: "¿Moderador que se casó con una seguidora del canal?", answer: "DOOPA" },
  ...
  { text: "¿El videoclip llamado \"Una vida por delante\" dirigido por Pol es de?", answer: "NACH" },
  { text: "¿Red social que premió a Polispol?", answer: "TIKTOK" },
  { text: "¿Pol coordinó y supervisó la transición de 4:3 a 16:9 para Aragón TV y ...?", answer: "TV3" },
  { text: "¿Colega Masón de Pol CEO de Twitch?", answer: "DAN CLANCY" },
  { text: "¿Amiga de Pol que vive en el campo?", answer: "POBLET" },
  { text: "¿Marca del coche de Pol?", answer: "TOYOTA" },
  { text: "¿Fortnite llevó a Pol a un evento en los?", answer: "ANGELES" },
  { text: "¿Animal al que la comunidad le hacía seguimiento a sus crías?", answer: "HALCON" },
  { text: "¿Qué elemento del Setup Pol quiere cambiar hace meses y no lo hace?", answer: "SILLA" },
  { text: "¿Serie en la que Pol nos prometió un barco de cine y no lo hizo?", answer: "PELAGO" },
  { text: "¿Cómo se refiere Pol a los viewers?", answer: "CHAT" },
  { text: "¿País de Latinoamérica en el que vivió Pol?", answer: "ARGENTINA" },
  { text: "¿Director de las películas de Batman favoritas donde aparece el Joker favorito de Pol?", answer: "TIM BURTON" },
  { text: "¿País en el que Pol encontró un accidente en GeoGuessr?", answer: "SENEGAL" },
  { text: "¿La casa que construyó Pol en Extremo 3 está inspirada en el artista?", answer: "BAD BUNNY" },
  { text: "¿Cuántos años cumple el sospechoso?", answer: "50" },
  { text: "¿Pol es alérgico a los?", answer: "MARISCOS" },
  { text: "¿Fuera de España Pol estudió en?", answer: "ESTADOS UNIDOS" },
  ...
  { text: "¿El trabajo de Pol le afectó las?", answer: "CERVICALES" },
  { text: "¿Hace 368 semanas Pol estuvo en California en el evento?", answer: "E3" },
  { text: "¿Último libro que Pol comenzó a leer?", answer: "EL BARRIO DE LOS DESEOS" },
  { text: "¿Cómo se llama el Discord de la comunidad de Pol?", answer: "CINEPOL" },
  { text: "¿Pol fue al Podcast Revival Plus a hablar de la película?", answer: "GREASE" },
  { text: "¿Película de amor favorita de Pol?", answer: "ABOUT TIME" },
  { text: "¿Streamer que mandó a callar a JK?", answer: "GRAF" },
  { text: "¿Pol grabó besándose a The Greft E?", answer: "ILLOJUAN" },
  { text: "¿Pol grabó el videoclip 'Juega' con?", answer: "NACH" },
  { text: "¿Junto a Falsalarma Pol grabó el videoclip de 'Bondad o '?", answer: "MALICIA" },
  { text: "¿Junto a Joan Manuel Serrat Pol grabó el videoclip 'Hijo de luz y de la '?", answer: "SOMBRA" },
  { text: "¿Junto a Estopa Pol grabó el videoclip de?", answer: "LA PRIMAVERA" },
  { text: "¿Como director técnico Pol participó en el concierto de?", answer: "ANTONIO OROZCO" },
  { text: "¿Servidor de Minecraft en el que participó Pol que inicia por Q?", answer: "QSMP" },
  { text: "¿El compañero de Pol en Disaster Chefs fue?", answer: "PATO" },
  { text: "¿POL?", answer: "NONI" },
  { text: "¿El primer stream de Pol fue un día?", answer: "VIERNES" },
  { text: "¿El primer stream de Pol fue el mes de?", answer: "NOVIEMBRE" },
  { text: "¿El primer stream de Pol fue el año?", answer: "2020" },
  { text: "¿Una de las casas de Pol en Tortillaland está inspirada en la película?", answer: "UP" },
  { text: "¿En Godzilla vs Kong Pol es team?", answer: "KONG" },
  { text: "¿De qué anime apareció vestida en casa de Pol PolisMom?", answer: "NARUTO" },
                        ...
                        {accessible && (
                          <div className="flex flex-col flex-1 min-h-0">
                            <div className="text-base text-neutral-600 mb-4 space-y-2 font-sans text-justify">
                              ...
                              {c.id === 7 && <><p>En nuestro último día de investigación daremos un repaso por algunos de los lugares donde hemos visto a Pol.</p><p>Deberá identificar el lugar correcto en el mapa basado en la pista de la imagen.</p></>}
